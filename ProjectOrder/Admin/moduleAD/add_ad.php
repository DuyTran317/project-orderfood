                    ...
                    <form role="form" action="process-ad.html" method="post" enctype="multipart/form-data">
                        <div class="box-body">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="account" required  name="account" placeholder="Nhập tài khoản">
                            </div>
                            <div class="form-group">
                                <label for="exampleInputPassword1">Tên <span style="color:#F00" >(*)</span></label>
                                <input type="text" class="form-control" id="ten" required name="ten" placeholder="Nhập tên">
                            </div>
