...
if(isset($_POST['suatheloai']))
{
    ...
    $sql_edit = "update `of_food` set `category_id`= '{$theloai}',`vi_name`='{$vi_tensp}',`en_name`='{$en_tensp}',`price`='{$gia}',`discount`='{$khuyenmai}',`vi_desc`='{$vi_noidung}',`en_desc`='{$en_noidung}',`order`='{$thutu}',
`active`='{$trangthai}'";
