...
<body style="background-image:url(img/front/pexels-photo-326333.jpeg); background-size: cover; font-family: 'Anton', sans-serif;">
    <div class="container">
        <div class="row"  style="background-color: #FFF; margin-top: 5%; border-radius: 20px; padding: 20px;">
            ...
            <!--Chuyển Bàn -->
            <a href="?mod=home" style="font-size:18px; color: #909; float:right; border:1px dotted #906; padding:10px 5px 10px 5px"><i class="fas fa-exchange-alt"></i> Quản Lý Chuyển Bàn</a>
